...
//    if (typeof $ === 'undefined') {
//        console.error("jQuery is not loaded. Please include it.");
//        return;
//    }
//    // Make sure Bootstrap is loaded
//    if (typeof bootstrap === 'undefined') {
//        console.error("Bootstrap is not loaded. Please include it.");
//        return;
//    }
...
//    if (e.key === "Enter") {
//        if (!isNaN(khoaId) && khoaId > 0 && !isNaN(phongId) && phongId > 0) {
//            e.preventDefault();
//            $("#saveRoomBtn").click();
//        }
...
//    if (e.key === "Backspace") {
//        this.value = "";
//        document.getElementById("selectedKhoaId").value = "";
//        $("#searchPhong").val("");
//        $("#selectedPhongId").val("");
//        if (phongDropdown) {
